...
-- Script date 09.12.2021 14:20:06
...
(1, 'Михаил', 'Нератканов', 3123, 134555, 'Омутнинск'),
(2, 'Евгения', 'Мармеладзе', 1414, 122334, 'Москва'),
(3, 'Валерий', 'Пепелац', 4345, 145321, 'Омск'),
(4, 'Геннадий', 'Котов', 2344, 156778, 'Сочи'),
(5, 'Елена', 'Головач', 3256, 123123, 'Томск'),
(6, 'Александр', 'Пушкин', 4443, 333444, 'Белореченск');
